...
@Api(value = "PriceServiceController", description = "This is price module controller class")
@RestController
...
@ApiOperation(value = "Get Price List in the System ", response = Iterable.class, tags = "findAllPrice")
@ApiResponses(value = { 
